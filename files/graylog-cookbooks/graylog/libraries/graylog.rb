...
module Graylog
  ...
  class << self
    ...
    def generate_settings
      ...
      Graylog['timezone']           = Graylog[:node]['graylog']['root_timezone'] if Graylog['timezone'].empty?
      Graylog['smtp_server']        = Graylog[:node]['graylog']['transport_email_hostname'] if Graylog['smtp_server'].nil?
      Graylog['smtp_port']          = Graylog[:node]['graylog']['transport_email_port'] if Graylog['smtp_port'].nil?
      Graylog['smtp_user']          = Graylog[:node]['graylog']['transport_email_auth_username'] if Graylog['smtp_user'].nil?
      Graylog['smtp_password']      = Graylog[:node]['graylog']['transport_email_auth_password'] if Graylog['smtp_password'].nil?
      Graylog['smtp_from_email']    = Graylog[:node]['graylog']['transport_email_from_email'] if Graylog['smtp_from_email'].nil?
      Graylog['smtp_web_url']       = Graylog[:node]['graylog']['transport_email_web_interface_url'] if Graylog['smtp_web_url'].nil?
      Graylog['smtp_no_tls']        ||= true
